...
namespace DevEdu.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        [Authorize]
        [HttpGet("get-by-login/{login}")]
        public async Task<ActionResult<UserOutputModel>> GetUserByLogin(string login)
        {
            User userByLoginPass = await userStorage.UserGetByLogin(login);
