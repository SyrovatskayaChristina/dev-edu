...
namespace DevEdu.Controllers
{
    ...
    public class LessonController : ControllerBase
    {
        ...
        [Authorize]
        [HttpGet("get-lesson-by-group/{id}")]
        public async Task<ActionResult<List<LessonOutputModel>>> GetAllLessonByGroup(string id)
        {
            List<Lesson> lessons = await lessonStorage.GetAllLessonByGroup(id);
            return Ok(LessonMapper.ToOutputModels(lessons));
        }
