...
namespace DevEdu.Data.Storages
{
    public class LessonStorage
    {
        ...
        internal static class SpName
        {
            ...
            public const string LessonSelectByGroupId = "Lesson_SelectByGroupID";
        ...
        public async Task<List<Lesson>> GetAllLessonByGroup(string id)
        {
            {
                try
                {
                    var result = await connection.QueryAsync<Lesson>(
                        SpName.LessonSelectByGroupId,
                        new {id},
                        dbTransaction,
                        commandType: CommandType.StoredProcedure);
                    return result.ToList();
