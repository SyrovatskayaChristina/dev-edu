...
namespace DevEdu.Data.Storages
{
    public class GroupStorage
    {
        ...
        internal static class SpName
        {
            ...
            public const string GetTeacherGroupsWithCourseProgramByTeacherId = "GetTeacherGroupsWithCourseProgram";
        ...
        public async Task<IEnumerable<GroupWithCourseProgram>> GetTeacherGroupsWithCourseProgramById(int userId)
        {
            try
            {
                var result = await connection.QueryAsync<GroupWithCourseProgram>(
                    SpName.GetTeacherGroupsWithCourseProgramByTeacherId,
                    new { userId },
                    dbTransaction,
                    commandType: CommandType.StoredProcedure
                );
